...
namespace fhfh
{
    public partial class MyDate : ContentPage
    {
        ...
        private void SetupDates()
        {
            ...
            surname.Text = UserInfo.client.surname;
            patronymic.Text = UserInfo.client.patronymic;
            gender.Text = UserInfo.client.gender;
            DateTime dateTime = UserInfo.client.data_of_birth;
        ...
        //            //Registration.Add(client);
        //            //UserInfo.client = Registration.Get(client);
