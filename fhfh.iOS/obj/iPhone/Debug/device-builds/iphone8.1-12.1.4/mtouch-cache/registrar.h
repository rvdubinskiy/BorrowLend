...
@interface fhfh_iOS_MyEnterRenderer : Xamarin_Forms_Platform_iOS_EntryRenderer {
}
	-(id) init;
@end
...
@interface fhfh_iOS_MyPickerRenderer : Xamarin_Forms_Platform_iOS_PickerRenderer {
}
	-(id) init;
@end
...
@interface fhfh_iOS_CustomPageRanderer : Xamarin_Forms_Platform_iOS_CarouselPageRenderer {
}
	-(id) init;
@end
...
@interface fhfh_iOS_CustomImageRenderer : Xamarin_Forms_Platform_iOS_ImageRenderer {
}
	-(id) init;
@end
...
@interface fhfh_iOS_Renderers_ChatEntryRenderer : Xamarin_Forms_Platform_iOS_ViewRenderer {
}
	-(id) init;
@end
...
@interface fhfh_iOS_Renderers_CustomEditorRenderer : Xamarin_Forms_Platform_iOS_EditorRenderer {
}
	-(id) init;
@end
...
@interface fhfh_iOS_Renderers_ExtendedListViewRenderer : Xamarin_Forms_Platform_iOS_ListViewRenderer {
}
	-(id) init;
@end
